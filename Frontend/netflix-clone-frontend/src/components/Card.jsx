...
export const Card = ({movieData , index , isLiked=false}) => {
        ...
        isHovered && (
          <div className="hover">
            ...
            <div className="info-container flex column">
              ...
              {
                isLiked ? (
                  <BsCheck title='Remove From List' onClick={()=> dispatch(removeUserLikedMovies({movieId: movieData.id , email}))} />
                ) : (
...
//ek video add krni hai or card or player m use hori h